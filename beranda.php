<div class="container">
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert abu">
                <strong>Selamat Datang di SI Booking Service CV.Honda Karya Utama</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-13">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Booking Service Sepeda Motor</h3>
                </div>
         ...
         <div class="col-sm-3 col-xs-12">
            ...
            <div class="panel panel-login">
                <div class="panel-heading1">
                    <h3 class="panel-title1">Masuk Ke Sistem</h3>
                </div>
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" name="login" value="login"
                                        class="btn honda btn-block"><span class="fa fa-unlock-alt"></span>
                                    Login Sistem
                                </button>
                            </div>
                    </form>
