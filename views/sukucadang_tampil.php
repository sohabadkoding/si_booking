                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?page=sukucadang&actions=edit&id=<?= $data['id'] ?>" class="btn btn-warning btn-xs">
                                            <span class="fa fa-edit"></span>
                                        </a>
                                        <a href="?page=sukucadang&actions=delete&id=<?= $data['id'] ?>" class="btn btn-danger btn-xs">
